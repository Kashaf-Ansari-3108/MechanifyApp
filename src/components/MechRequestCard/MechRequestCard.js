        ...
        <>
            <View style={[styles.main, { flexDirection: 'row' }]}>
                ...
                <View style={{ flex: 1, justifyContent: 'space-around' }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("MechViewRequest", item)} style={[styles.icon, { backgroundColor: blue, }]}>
...
export default MechRequestCard
